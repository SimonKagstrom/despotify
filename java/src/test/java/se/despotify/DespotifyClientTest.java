...
public abstract class DespotifyClientTest extends TestCase {
  ...
  protected Playlist defaultPlaylist = store.getPlaylist(Hex.toBytes(SpotifyURI.toHex("6wvPFkLGKOVl1v3qRJD6HX")));

  protected Artist[] defaultArtists = new Artist[]{
  ...
  protected Album[] defaultAlbums = new Album[]{
  ...
  protected Track[] defaultTracks = new Track[]{
