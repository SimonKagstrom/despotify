...
import se.despotify.domain.media.MediaTestCaseGenerator;
...
// < test generation
    ...
    album.accept(new VisitorAdapter() {
      ...
      public void visit(Album album) {
        ...
        assertEquals("78fa2ba4d4124b51a708dd074c62d24c", track.getHexUUID());
        assertEquals("spotify:track:3GhpgjhCNZZa6Lb7Wtrp3S", track.getSpotifyURL());
        ...
        assertEquals("728f02c7fc5d4a1c83ae91a88b455d6c", track.getHexUUID());
        assertEquals("spotify:track:3uatQAOZ90mnrixwhKiSAI", track.getSpotifyURL());
        ...
        assertEquals("8bd3f688cf9f4c96ad3926eda6ebf87a", track.getHexUUID());
        assertEquals("spotify:track:4fQNEmRzjhgmPe5TkL6WNQ", track.getSpotifyURL());
        ...
        assertEquals("3515cd3fba3249ca83f746da0a2e1faa", track.getHexUUID());
        assertEquals("spotify:track:1Caywbok6SQb7czVXzi2ro", track.getSpotifyURL());
        ...
        assertEquals("8441c41dbfda4bb1b66f2b68ac330447", track.getHexUUID());
        assertEquals("spotify:track:41z2CLPSwQVA0hVNvu28ej", track.getSpotifyURL());
        ...
        assertEquals("f07783cebc8f4bafa2fce8c6d0cc1deb", track.getHexUUID());
        assertEquals("spotify:track:7jKMavlOi9N4ZZG6755hk7", track.getSpotifyURL());
        ...
        assertEquals("ddd9350f4c2246e19de7b203d5bb1aff", track.getHexUUID());
        assertEquals("spotify:track:6KCzeoC39w23DZ3tZ88mKz", track.getSpotifyURL());
        ...
        assertEquals("2e5144d2fbb14cf9889410dde3f62f63", track.getHexUUID());
        assertEquals("spotify:track:1poMNfOIDOIxltyUYjV6qn", track.getSpotifyURL());
        ...
        assertEquals("da1b14a8928d4f19b0758e49076d1451", track.getHexUUID());
        assertEquals("spotify:track:6DyHB5mWMzUfP3QEXwwVUZ", track.getSpotifyURL());
        ...
        assertEquals("e376c1392b8f42539a0668445657492b", track.getHexUUID());
        assertEquals("spotify:track:6VdwOFKf0u6hLVtXcL8CWn", track.getSpotifyURL());
        ...
        assertEquals("d7ac88008f5a4924969941721d6ebec7", track.getHexUUID());
        assertEquals("spotify:track:6yYcerWiS6tebVzoIpu74j", track.getSpotifyURL());
        ...
        assertEquals("730da679d40443e28b64b4ab44e7b554", track.getHexUUID());
        assertEquals("spotify:track:3v6m3ICCXoMzZw3EMr5Kn2", track.getSpotifyURL());
        ...
        assertEquals("75ca03b768d040a3b6b9197faeaa5bfa", track.getHexUUID());
        assertEquals("spotify:track:3AgqeAt9qzUdSBor27IRn4", track.getSpotifyURL());
        ...
        assertEquals("e6d3c0171555466496dc31180ebcd98d", track.getHexUUID());
        assertEquals("spotify:track:71z0kIckftTVfBSG0HBHAx", track.getSpotifyURL());
        ...
        assertEquals("84630de2b70044938abadc2b5b004717", track.getHexUUID());
        assertEquals("spotify:track:41OfOvVyuD5x185BTOW0ET", track.getSpotifyURL());
        ...
        assertEquals("d73b8e4253f2474793691045569a2002", track.getHexUUID());
        assertEquals("spotify:track:6y8zaPjL3eHZW3UAuL2VJo", track.getSpotifyURL());
        ...
        assertEquals("87e27d275915442ba1d3d09053ad6696", track.getHexUUID());
        assertEquals("spotify:track:48pt86Kh5s2cuhkJLy1Pue", track.getSpotifyURL());
        ...
        assertEquals("565e4c91f4ae42a39aa5646d325590e3", track.getHexUUID());
        assertEquals("spotify:track:2CYqXSe4pzCqpSWZvqgE39", track.getSpotifyURL());
        ...
        assertEquals("3deaacde160b4df9aa2a5ddac44dd2a0", track.getHexUUID());
        assertEquals("spotify:track:1SPMhRJlmBukPQuv3nIlAA", track.getSpotifyURL());
        ...
        assertEquals("c2d8c567f4db4adc83120d132657955c", track.getHexUUID());
        assertEquals("spotify:track:5VFzIzR8nACf9Bad4O73f6", track.getSpotifyURL());
        ...
        assertEquals("d00d9e7b82894fb8851a109c82568eb5", album.getArtist().getHexUUID());
        assertEquals("spotify:artist:6kACVPfCOnqzgfEF5ryl0x", album.getArtist().getSpotifyURL());
    ...
    album.accept(new VisitorAdapter() {
      ...
      public void visit(Album album) {
        ...
        track = album.getTracks().get(0);
        assertEquals("440a880a046e40eb905796a2720aa397", track.getHexUUID());
        assertEquals("spotify:track:24oi2ZcdtjTFDsbVs3tjAb", track.getSpotifyURL());
        ...
        track = album.getTracks().get(2);
        assertEquals("0d6da839f28d43db8340cf00ff259358", track.getHexUUID());
        assertEquals("spotify:track:0pl0QFnT982MoMkNOG7Jhu", track.getSpotifyURL());
        ...
        track = album.getTracks().get(3);
        assertEquals("df78c7bcd413493996b85cea57114ff1", track.getHexUUID());
        assertEquals("spotify:track:6NGu6Ms3wByHSiJVYLgaS5", track.getSpotifyURL());
        ...
        track = album.getTracks().get(4);
        assertEquals("96d10e3865e148ecb45c8c7cd85942c3", track.getHexUUID());
        assertEquals("spotify:track:4AAo2jSIOpiXGVZpMNAbkf", track.getSpotifyURL());
        ...
        track = album.getTracks().get(5);
        assertEquals("d502235382984bc58fb138edf1cf9877", track.getHexUUID());
        assertEquals("spotify:track:6tWlfogLs4i7F3aC8nwYHJ", track.getSpotifyURL());
        ...
        track = album.getTracks().get(6);
        assertEquals("fe24aae4b84c4f81a6cff8e8cb76eda4", track.getHexUUID());
        assertEquals("spotify:track:7JyO6CeRnQI4Fz3Lm70hms", track.getSpotifyURL());
        ...
        track = album.getTracks().get(7);
        assertEquals("1e4929b9f87545ba97f83a07827e9a3e", track.getHexUUID());
        assertEquals("spotify:track:0V9cJwuy5JCmKM9XDcTerk", track.getSpotifyURL());
        ...
        track = album.getTracks().get(8);
        assertEquals("d6592db3a888473c912ee572f4a8ad8f", track.getHexUUID());
        assertEquals("spotify:track:6wt6Z7lgWUKuTsooVRjR4H", track.getSpotifyURL());
        ...
        track = album.getTracks().get(9);
        assertEquals("ea43e3a144e7450c8fc5f22758595c5c", track.getHexUUID());
        assertEquals("spotify:track:783efX6wNRPhii3dGfdIDO", track.getSpotifyURL());
        ...
        track = album.getTracks().get(10);
        assertEquals("c64fc8e8b9fa4e1c95dcc98558857a6b", track.getHexUUID());
        assertEquals("spotify:track:62cWqXZyQIhGWfb2aeCyTx", track.getSpotifyURL());
        ...
        track = album.getTracks().get(11);
        assertEquals("e826997fe8b443d5aff0c4e5e9f56ae3", track.getHexUUID());
        assertEquals("spotify:track:743RjzEhzIsAFwYwPMyLeP", track.getSpotifyURL());
        ...
        track = album.getTracks().get(12);
        assertEquals("9b1b38c422a14039973ddbbc51108fd0", track.getHexUUID());
        assertEquals("spotify:track:4IGfz3eAl6eRNv1OMufxIY", track.getSpotifyURL());
        ...
        track = album.getTracks().get(13);
        assertEquals("cb055b8b790e4b3480e3ebf4c3c4193c", track.getHexUUID());
        assertEquals("spotify:track:6b5TegeCtLqLac3iu8xMIs", track.getSpotifyURL());
        ...
        track = album.getTracks().get(14);
        assertEquals("04920e964b65440ab0255c8c540e15b3", track.getHexUUID());
        assertEquals("spotify:track:08CIucCl4AK4m8xeAcBndp", track.getSpotifyURL());
        ...
        track = album.getTracks().get(15);
        assertEquals("b698bd814767422390d66b72a0bf9b0c", track.getHexUUID());
        assertEquals("spotify:track:5yypaFOfcl5J7zqTtlg5kM", track.getSpotifyURL());
        ...
        track = album.getTracks().get(16);
        assertEquals("2983c7def4134f3aa591189199b0b881", track.getHexUUID());
        assertEquals("spotify:track:1gkUnDFauJz6XGMU1e7J5f", track.getSpotifyURL());
        ...
        track = album.getTracks().get(17);
        assertEquals("69afb25b304344b8a81644b31b3b7439", track.getHexUUID());
        assertEquals("spotify:track:3dqufGyqCKtyXkcB1xxxeF", track.getSpotifyURL());
        ...
        track = album.getTracks().get(18);
        assertEquals("d9533d14214d4c99a5bc2ac2d6332917", track.getHexUUID());
        assertEquals("spotify:track:6C5nfSccea6oLEryJ9N3Yr", track.getSpotifyURL());
        ...
        track = album.getTracks().get(19);
        assertEquals("02e37a05d72a49b4bc17e4f9b30dbf5f", track.getHexUUID());
        assertEquals("spotify:track:05rWobbKhM4Em2GKbWYQnt", track.getSpotifyURL());
        ...
        assertEquals("4f9873e19e5a4b4096c216c98bcdb010", album.getArtist().getHexUUID());
        assertEquals("spotify:artist:2qc41rNTtdLK0tV3mJn2Pm", album.getArtist().getSpotifyURL());
    ...
    album.accept(new VisitorAdapter() {
      ...
      public void visit(Album album) {
        ...
        track = album.getTracks().get(0);
        assertEquals("6d9216aaeaf648f68bb4cc90d0579b84", track.getHexUUID());
        assertEquals("spotify:track:3kKVqFF4pv4EXeQe428zl2", track.getSpotifyURL());
        ...
        track = album.getTracks().get(1);
        assertEquals("86b571617c24410194bb3450f837a13f", track.getHexUUID());
        assertEquals("spotify:track:46bTgJAQkrkNRxMuFnpRyD", track.getSpotifyURL());
        ...
        track = album.getTracks().get(3);
        assertEquals("936004d9503e408ca8a3aab8c3a00720", track.getHexUUID());
        assertEquals("spotify:track:4u5KFWcW1ptk0hJqp2lrCE", track.getSpotifyURL());
        ...
        track = album.getTracks().get(4);
        assertEquals("d77651fe713946f6aecd0bf4b8271f8c", track.getHexUUID());
        assertEquals("spotify:track:6yzqdl5qv6BGu6BlRNWIDa", track.getSpotifyURL());
        ...
        track = album.getTracks().get(5);
        assertEquals("906254b85ef340d6a82e99a4f9649543", track.getHexUUID());
        assertEquals("spotify:track:4orPBWfQNUxs3RObirJwZR", track.getSpotifyURL());
        ...
        track = album.getTracks().get(6);
        assertEquals("bd6cf00bfdac407382ed9fe31c0059d0", track.getHexUUID());
        assertEquals("spotify:track:5LrkJFmitzUrKZnt5iXl8A", track.getSpotifyURL());
        ...
        track = album.getTracks().get(7);
        assertEquals("fd6e4b330b3e45339bc733a6e010a923", track.getHexUUID());
        assertEquals("spotify:track:7IdsIcmcti4v5VXkCJ3ou7", track.getSpotifyURL());
        ...
        track = album.getTracks().get(8);
        assertEquals("301c0561a43044a7bd7fc3bcd4546e41", track.getHexUUID());
        assertEquals("spotify:track:1sMr77QrXyS9LRIhcCI2el", track.getSpotifyURL());
        ...
        track = album.getTracks().get(9);
        assertEquals("3927d8f0a4d34133b4babc44bfb9b901", track.getHexUUID());
        assertEquals("spotify:track:1JQLVgeRWU7Hf7y8EpmOqd", track.getSpotifyURL());
        ...
        assertEquals("db614c7060fc47baa7be732d88ae446d", album.getArtist().getHexUUID());
        assertEquals("spotify:artist:6FXMGgJwohJLUSr5nVlf9X", album.getArtist().getSpotifyURL());
    ...
    album.accept(new VisitorAdapter() {
      ...
      public void visit(Album album) {
        ...
        track = album.getTracks().get(0);
        assertEquals("c436ce17825947128b2dc42afc534793", track.getHexUUID());
        assertEquals("spotify:track:5YfxBHo9eqlyNcECl6rnQT", track.getSpotifyURL());
        ...
        track = album.getTracks().get(1);
        assertEquals("0318df1a31e6424ea2007325113bc062", track.getHexUUID());
        assertEquals("spotify:track:05QlhAtZvmw8FJEGnY43Bw", track.getSpotifyURL());
        ...
        track = album.getTracks().get(3);
        assertEquals("a41be5cf75194e58bfdadbae72b3384a", track.getHexUUID());
        assertEquals("spotify:track:4ZFur3kCESWiJeypvgVZ34", track.getSpotifyURL());
        ...
        track = album.getTracks().get(4);
        assertEquals("f086aa9a46e6455eb7455bc63a6f5447", track.getHexUUID());
        assertEquals("spotify:track:7jRHtpSkj3GPmqJGVsY1qT", track.getSpotifyURL());
        ...
        track = album.getTracks().get(5);
        assertEquals("eb7db7d1b62a443986544a4e9e7fe5d2", track.getHexUUID());
        assertEquals("spotify:track:7amEjazqkOWSh71SAf3xZM", track.getSpotifyURL());
        ...
        track = album.getTracks().get(6);
        assertEquals("2d723102f82f42ffbf7c80363d0b0117", track.getHexUUID());
        assertEquals("spotify:track:1nKQ6jNqXLO6qXUk4Jv9LV", track.getSpotifyURL());
        ...
        track = album.getTracks().get(7);
        assertEquals("a986144d154c4685bd24ae7950baabbd", track.getHexUUID());
        assertEquals("spotify:track:59SYCaLBK41rjpoj268Eep", track.getSpotifyURL());
        ...
        track = album.getTracks().get(8);
        assertEquals("192f8dd889c64cab9058d81b336727f6", track.getHexUUID());
        assertEquals("spotify:track:0LwxvuWvgRNQ2ABGN1goFU", track.getSpotifyURL());
        ...
        assertEquals("f4d5d82d09124feda0633a2671f8c81a", album.getArtist().getHexUUID());
        assertEquals("spotify:artist:7rZR0ugcLEhNrFYOrUtZii", album.getArtist().getSpotifyURL());
    ...
    album.accept(new VisitorAdapter() {
      ...
      public void visit(Album album) {
        ...
        track = album.getTracks().get(0);
        assertEquals("95e5d43024a3426788fc2b1cddc56f17", track.getHexUUID());
        assertEquals("spotify:track:4yQT6yJR3OcL3PLKsCKXjx", track.getSpotifyURL());
        ...
        track = album.getTracks().get(1);
        assertEquals("df237a0344a044c3b2241b02b91dc8c5", track.getHexUUID());
        assertEquals("spotify:track:6N3v6P4QFiD6v8Xc1WZdD7", track.getSpotifyURL());
        ...
        track = album.getTracks().get(2);
        assertEquals("8c1e7f5cbbc14462bce956e0a09bcc75", track.getHexUUID());
        assertEquals("spotify:track:4goRw3CP6Ke3aLZslgXbpP", track.getSpotifyURL());
        ...
        track = album.getTracks().get(3);
        assertEquals("3d407e2c693244d88bd6fb9681e49bff", track.getHexUUID());
        assertEquals("spotify:track:1RA0kfuQBrmcmuPPo0x0w7", track.getSpotifyURL());
        ...
        track = album.getTracks().get(4);
        assertEquals("4fed16657cc04aa69f69b9deca1989cc", track.getHexUUID());
        assertEquals("spotify:track:2qOK4xkpjWsXDM65VMpe56", track.getSpotifyURL());
        ...
        track = album.getTracks().get(5);
        assertEquals("84c923148ab34771a42b8c41968fc965", track.getHexUUID());
        assertEquals("spotify:track:42yUeFI77nh5TV3M8SGV3T", track.getSpotifyURL());
        ...
        track = album.getTracks().get(6);
        assertEquals("64f67f33b9824986b9b5e03abc5b2eb3", track.getHexUUID());
        assertEquals("spotify:track:34vSGKwatlJFBtJuRDkHo7", track.getSpotifyURL());
        ...
        track = album.getTracks().get(7);
        assertEquals("f84cd8282f984e6c8233c4f58f74a73f", track.getHexUUID());
        assertEquals("spotify:track:7yxdkHY6hSUDVJnNhJ8boj", track.getSpotifyURL());
        ...
        track = album.getTracks().get(9);
        assertEquals("de8a77d4292f4dd9b106f1bb5abcf8eb", track.getHexUUID());
        assertEquals("spotify:track:6LVzKLdwFRbCJKAsEA0pKz", track.getSpotifyURL());
        ...
        track = album.getTracks().get(10);
        assertEquals("e67549687c5046aaa3b46de9367aa9a3", track.getHexUUID());
        assertEquals("spotify:track:70RPNhD2lWbwDZZPWCTWtd", track.getSpotifyURL());
        ...
        assertEquals("f6150726a8e94c89a7cf336d3f72be9c", album.getArtist().getHexUUID());
        assertEquals("spotify:artist:7ulIMfVKiXh8ecEpAVHIAY", album.getArtist().getSpotifyURL());
